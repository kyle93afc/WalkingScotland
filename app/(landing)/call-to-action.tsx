        ...
        <section className="py-16 px-6">
            <div className=" mx-auto max-w-5xl rounded-3xl px-6 py-12 md:py-20 lg:py-32">
                ...
                <div className="absolute text-center">
                    <h2 className="text-balance text-4xl font-semibold lg:text-5xl">Start Your Scottish Adventure</h2>
                    <p className="mt-4">Join thousands of walkers exploring Scotland&apos;s most spectacular routes.</p>
