...
## Tasks / Subtasks
- [ ] Task 1: Remove billing and subscription components (AC: 1, 3)
  - [ ] Subtask 1.1: Locate and remove ClerkBillingGate components from walking features
  - [ ] Subtask 1.2: Remove custom-clerk-pricing.tsx component and references
  - [ ] Subtask 1.3: Clean up payment-gated dashboard sections in app/dashboard/payment-gated/
  - [ ] Subtask 1.4: Remove billing-related middleware and route protection
  - [ ] Subtask 1.5: Update package.json to remove Clerk Billing dependencies
- [ ] Task 2: Transform dashboard to walking-focused features (AC: 2, 5)
  - [ ] Subtask 2.1: Replace subscription management with walking statistics dashboard
  - [ ] Subtask 2.2: Add personal walking achievements and progress tracking
  - [ ] Subtask 2.3: Create user walk history and favorite walks sections
  - [ ] Subtask 2.4: Implement walking preferences and profile settings
  - [ ] Subtask 2.5: Preserve existing user data and walk reports during transition
- [ ] Task 3: Simplify user registration for walking context (AC: 4, 5)
  - [ ] Subtask 3.1: Update Clerk registration flow to capture walking preferences
  - [ ] Subtask 3.2: Remove billing information collection from signup
  - [ ] Subtask 3.3: Add optional fields for walking experience level
  - [ ] Subtask 3.4: Ensure existing user accounts remain functional
  - [ ] Subtask 3.5: Test registration flow doesn't break existing authentication
- [ ] Task 4: Remove payment restrictions from walking features (AC: 3, 5)
  - [ ] Subtask 4.1: Audit all components for ClerkBillingGate usage
  - [ ] Subtask 4.2: Make walk discovery and detailed views freely accessible
  - [ ] Subtask 4.3: Remove subscription checks from walk reporting features
  - [ ] Subtask 4.4: Ensure user statistics and achievements are openly available
- [ ] Task 5: Preserve data integrity during authentication changes (AC: 5)
  - [ ] Subtask 5.1: Test existing user login sessions remain valid
  - [ ] Subtask 5.2: Verify walk reports and user data are preserved
  - [ ] Subtask 5.3: Ensure user statistics tracking continues working
  - [ ] Subtask 5.4: Test Convex user sync continues functioning properly
